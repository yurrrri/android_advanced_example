...
//Input : 주소 String, Output : String 타입의 XML 결과
    class NetworkAsyncTask extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... strings) {
            String address = strings[0]; // api url
            String result = downloadContents(address); //url에서 받아온 xml결과를 string으로 저장하여 반환한 것
            if (result == null) {
                cancel(true);
...
//          parser 생성 및
//          OpenAPI 수신 결과(XML 결과를 String으로 저장하여 반환한 결과)를 사용하여 parsing 수행
